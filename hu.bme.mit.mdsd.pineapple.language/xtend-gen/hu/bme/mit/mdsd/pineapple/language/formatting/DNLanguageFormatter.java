 ...
 * generated by Xtext
 */
package hu.bme.mit.mdsd.pineapple.language.formatting;
...
public class DNLanguageFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private DNLanguageGrammarAccess _dNLanguageGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._dNLanguageGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._dNLanguageGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._dNLanguageGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._dNLanguageGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._dNLanguageGrammarAccess.getML_COMMENTRule();
