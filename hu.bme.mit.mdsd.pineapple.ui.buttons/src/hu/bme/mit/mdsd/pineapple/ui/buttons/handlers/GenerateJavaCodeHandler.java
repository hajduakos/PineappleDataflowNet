...
public class GenerateJavaCodeHandler extends AbstractDataflowNetHandler {
    ...
    protected void handleFile(ExecutionEvent event, IFile file) {
        ...
        if (isSuccessfullyValidatedModelWithIncQuery && isValidDefault) {
            ...
            String message = "The Java code generation cannot be started while the model is not valid.";
